...
[![Build Status](https://travis-ci.org/pc035860/SNAugusPopView.svg?style=fla)](https://travis-ci.org/pc035860/SNAugusPopView)
...
![](https://github.com/venn0126/iOS-Study/blob/master/Resource/SNAugusPopView/Kapture%202022-08-19%20at%2000.20.30-min.gif?raw=true)
...
`SNAugusPopView`可以运行在`iOS 9+`的系统版本。它依赖以下的苹果框架，这些框架都已经内嵌在该库中
